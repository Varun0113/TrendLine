...
This project is a Django-based news web application that delivers
category-wise news using the NewsAPI.

It is designed with a clear distinction between public users and
authenticated users, where advanced features are intentionally locked
behind login to improve user engagement and platform value.

The application focuses on clean architecture, basic security practices,
and a scalable foundation for future enhancements.

**Project Overview**

The platform allows users to browse news content with limited access on
the home page. After registering and logging in, users gain access to an
expanded dashboard featuring more news categories, an AI chatbot, and
curated sidebars for recent and trending news.

This approach reflects a real-world product model rather than an
open-access demo application.
